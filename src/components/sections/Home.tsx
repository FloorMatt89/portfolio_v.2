...
export default function Home() {
  ...
  const socials = [
    {
      title: "GitHub",
      href: "https://github.com/Floormatt89",
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-purple-blue text-2xl md:text-3xl">Hello there fellow traveler</h1>
      <p className="text-lg text-gray-white">
        Big on BIG DATA and mobile development
      </p>
